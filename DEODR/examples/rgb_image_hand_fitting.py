...
from DEODR import readObj, MeshRGBFitter, MeshRGBFitter2
...
def main():
    ...
    handFitter=MeshRGBFitter2(vertices,faces,defaultColor=defaultColor,defaultLight=defaultLight,  updateLights =  True, updateColor= True,euler_init=euler_init,translation_init=translation_init, cregu=1000)   
